...
func LoginUser(client *mongo.Client) gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		token, refreshToken, err := util.GenerateAllTokens(foundUser.Email, foundUser.FirstName, foundUser.LastName, foundUser.Role, foundUser.UserID)
...
func LogoutHandler(client *mongo.Client) gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		err = util.UpdateAllTokens(UserLogout.UserId, "", "", client) // Clear tokens in the database
...
func RefreshTokenHandler(client *mongo.Client) gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		claim, err := util.ValidateRefreshToken(refreshToken)
		...
		newToken, newRefreshToken, _ := util.GenerateAllTokens(user.Email, user.FirstName, user.LastName, user.Role, user.UserID)
		err = util.UpdateAllTokens(user.UserID, newToken, newRefreshToken, client)
		if err != nil {
